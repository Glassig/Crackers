This research was performed using gamification by implementing two versions of a text-based game. Test were then performed where a test group played both versions and evaluated them separately. 
